...
def get_fact_rule_identifiers(data_dir, eval_split):
...
def process(param_list):
    ...
    edges = solve_LP(edge_logit, fact_rule_identifier, node_pred)
...
if __name__ == '__main__':
    ...
    fact_rule_identifiers = get_fact_rule_identifiers(args.data_dir, args.eval_split)
