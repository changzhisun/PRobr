...
def get_gold_proof_nodes_edges(data_dir, natlang_metadata, eval_split):
...
if __name__ == '__main__':
    ...
    all_gold_proofs, all_gold_labels = get_gold_proof_nodes_edges(args.data_dir, args.natlang_metadata, args.eval_split)
