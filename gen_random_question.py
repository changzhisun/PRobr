...
if __name__ == "__main__":
    ...
    out_data_dir = "./data/depth-5-random-question-%dk" % (question_num)
    random.seed(42)
    num_lines = count_question_num(os.path.join(in_data_dir, "train.jsonl"))
    permutation = list(range(num_lines))
    random.shuffle(permutation)
    permutation = permutation[: question_num * 1000]
